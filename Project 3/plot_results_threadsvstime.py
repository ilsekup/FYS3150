...
filenames = ["estimates_MonteCarlo1.txt","estimates_MonteCarlo2.txt"\
, "estimates_MonteCarlo3.txt","estimates_MonteCarlo4.txt"]
...
# Initialize lists
    ...
    plt.plot(threads[k], t_avg, "x",label = r"Brute force MC ($\infty = 2$) with %i threads " % threads[k],markersize = 6)


# Repeat for importance sampling

filenames = ["estimates_MonteCarlo_imps1.txt","estimates_MonteCarlo_imps2.txt"\
, "estimates_MonteCarlo_imps3.txt","estimates_MonteCarlo_imps4.txt"]
...
for k in range(len(filenames)):
    ...
    plt.plot(threads[k],t_imps_avg, "x",label = "MC IS with %i threads " % threads[k],markersize = 6)


plt.ylabel( "time [s]", fontsize = 14)
plt.xlabel("Number of threads", fontsize = 14)
plt.title("Mean time as a function of number of threads",fontsize = 16)
plt.grid()
plt.legend(fontsize = 12)
plt.savefig("threadVStime.png")
